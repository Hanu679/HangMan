...
class HangmanGame:
    def __init__(self, root):
        ...
        self.instruction_menu = tk.Menu(self.menu_bar, tearoff=0)
        self.menu_bar.add_cascade(label="How to Play", command=self.display_instructions)
        # self.instruction_menu.add_command(label="How to Play", command=self.display_instructions)
    ...
    def display_instructions(self):
        ...
        instructions = (
            ...
            "To play the game, you need to guess the hidden word by entering one Alphabet at a time.\n"
            "You have a limited number of attempts to guess the word. Each incorrect guess results "
            "in the drawing of a part of the hangman.\n\n"
            "Good luck!"
        )
    ...
    def check_guess(self):
        ...
        if len(guess) != 1 or not guess.isalpha():
            messagebox.showwarning("Invalid Guess", '''Please enter a Single "Alphabet"''')
            return
